...
from protobuf.spacex.api.device import device_pb2 as spacex_dot_api_dot_device_dot_device__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f" but the generated code in spacex/api/device/service_pb2_grpc.py depends on"
...
def add_DeviceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("SpaceX.API.Device.Device", rpc_method_handlers)
